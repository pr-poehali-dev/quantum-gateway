...
const artists: Artist[] = [
  {
    name: "Крипер",
    specialty: "Взрывной моб",
    years: "2009-настоящее время",
    nationality: "Майнкрафт",
    portrait: "/placeholder.svg?height=300&width=300",
    image: "/placeholder.svg?height=600&width=480",
    bio: "Самый узнаваемый враждебный моб в Майнкрафте. Бесшумно подкрадывается и взрывается рядом с игроками. Наш роботизированный Крипер двигается, светится и издаёт характерное шипение — но не волнуйтесь, он совершенно безопасен!",
    famousWorks: "Взрывы, шипение, разрушение построек",
  },
  {
    name: "Эндермен",
    specialty: "Телепортирующийся моб",
    years: "2010-настоящее время",
    nationality: "Майнкрафт",
    portrait: "/placeholder.svg?height=300&width=300",
    image: "/placeholder.svg?height=600&width=480",
    bio: "Загадочное высокое существо из измерения Край. Может телепортироваться и переносить блоки. Робот-Эндермен умеет двигаться, издавать жуткие звуки и светиться фиолетовыми глазами в темноте!",
    famousWorks: "Телепортация, перенос блоков, странные звуки",
  },
  {
    name: "Оптимус Прайм",
    specialty: "Лидер Автоботов",
    years: "1984-настоящее время",
    nationality: "Кибертрон",
    portrait: "/placeholder.svg?height=300&width=300",
    image: "/placeholder.svg?height=600&width=480",
    bio: "Легендарный предводитель Автоботов, защитник Земли и борец за справедливость. Трансформируется в грузовик. Наша интерактивная модель может двигаться, говорить знаменитыми фразами и даже частично трансформироваться!",
    famousWorks: "Защита Земли, битвы с Десептиконами, трансформация",
  },
  {
    name: "Бамблби",
    specialty: "Разведчик Автоботов",
    years: "1984-настоящее время",
    nationality: "Кибертрон",
    portrait: "/placeholder.svg?height=300&width=300",
    image: "/placeholder.svg?height=600&width=480",
    bio: "Самый дружелюбный и храбрый разведчик команды Оптимуса Прайма. Трансформируется в жёлтый спортивный автомобиль. Робот-Бамблби двигается, издаёт звуки и общается через радиосигналы!",
    famousWorks: "Разведка, дружба с людьми, быстрые атаки",
  },
  {
    name: "Зомби",
    specialty: "Классический враждебный моб",
    years: "2009-настоящее время",
    nationality: "Майнкрафт",
    portrait: "/placeholder.svg?height=300&width=300",
    image: "/placeholder.svg?height=600&width=480",
    bio: "Один из первых враждебных мобов в Майнкрафте. Появляется ночью и издаёт характерные стоны. Наш робот-зомби двигается как настоящий, издаёт жуткие звуки и может менять выражение 'лица'!",
    famousWorks: "Ночные нападения, громкие стоны, групповые атаки",
  },
  {
    name: "Мегатрон",
    specialty: "Лидер Десептиконов",
    years: "1984-настоящее время",
    nationality: "Кибертрон",
    portrait: "/placeholder.svg?height=300&width=300",
    image: "/placeholder.svg?height=600&width=480",
    bio: "Злейший враг Оптимуса Прайма и предводитель Десептиконов. Мощный и безжалостный воин. Интерактивная модель Мегатрона впечатляет размерами, светящимися глазами и грозными движениями!",
    famousWorks: "Завоевание галактики, битвы с Автоботами, трансформация в оружие",
  },
  {
